...
function InicioServicios() {
  return (
    <div>
      ...
      <p className="casos-de-exito texto-grande" style={{ color: 'black', marginLeft:'80px',marginTop:'100px',marginBotton:'60px' }}>Servicios</p>
        
      
      <p className="texto-normal" style={{ color: 'black',marginTop:'30px', marginLeft:'75px', color: 'grey'}}>
      Siempre se puede dar más, y eso es lo que hacemos.</p>
      
    
        <p style={{ color: 'black',marginTop:'30px', marginLeft:'75px', color: 'grey', textAlign:'justify',width:' 1250px'}}>Los detalles marcan la diferencia, por eso en Ominova creemos que la calidad sólo puede venir
      acompañada de perfiles especializados (y enamorados) en sus oficios. Creamos departamentos independientes e interconectados de cada servicio.</p>
      ...
      <div className="texto-izquierda-negrita">
        ...
        <div className="contenedor-imagen-texto">
          ...
          <div className="texto-hablamos">
            ...
            <p className="texto-normal1" style={{alingtext:'justify',width:'649px'}} >
