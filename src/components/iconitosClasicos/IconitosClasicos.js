...
function IconitosClasicos() {
  return (
    ...
    >
      ...
      >
        <a
          href="https://api.whatsapp.com/send?phone=+34656xxxx9&text=Chatea%20en%20WhatsApp%20con%20el%20+34%20616khjkhs56"
          target="_blank"
      ...
      >
        <p>
          ...
          {/* Añadir espacio entre "Aviso Legal" y "Política de Privacidad" */}
          <Link
          ...
          {/* Añadir espacio entre "Política de Privacidad" y "Política de Cookies" */}
          <Link
          ...
          <span style={{ margin: '0 5px' }}></span>{' '}
          {/* Añadir espacio entre "Política de Cookies" y el símbolo */}© 2025
          Ominova. Todos los derechos reservados
        </p>
      </div>
    </nav>
  );
