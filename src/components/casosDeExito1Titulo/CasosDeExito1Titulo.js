  ...
  return (
    <div>
      ...
      >
        ...
        >
          <p>
            CHAGAR| PEDRO LUIS es un almacén mayorista que se dedica a la
            distribución de suministros técnicos y venta de materiales
            especializados para profesionales.
          </p>
          <div
            style={{
              fontFamily: 'Arial',
