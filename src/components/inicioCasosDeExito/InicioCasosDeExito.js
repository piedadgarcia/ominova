...
function InicioCasosDeExito() {
  ...
  return (
    <div style={{ marginTop: '90px', marginTop:`${350}px`,marginBottom:'30px' }}> {/* Usa la altura dinámica del NavMenu */}{/* Ajusta el margen superior */}
        ...
        <div className="columna-derecha">
          <div className="texto-contenedor">
            <div className="texto-verde-container" style={{ textAlign: 'left' }}>
              ...
              <p className="casos-de-exito texto-grande" style={{ color: 'black', marginLeft:'80px',marginTop:'-200px',marginBotton:'60px' }}>Casos de éxito</p>
              <p className="texto-normal texto-una-linea" style={{ color: 'black',marginTop:'30px', marginLeft:'75px', color: 'grey'}}>¿Quieres ver de qué somos capaces? Nada te lo va a contar mejor que nuestro trabajo. </p>
              <p className="texto-normal texto-una-linea" style={{ color: 'black',marginTop:'30px', marginLeft:'75px', color: 'grey'}}> Aquí tienes una pequeña selección de casos.</p>
              <p className="descubre-casos-exito" style={{ color: 'black',marginTop:'30px', marginLeft:'75px' }}>Descubre nuestros casos de éxito</p>
  ...
  />
              ...
              <div className="enfocamos-objetivos">
                <div style={{ display: 'flex', alignItems: 'center'}}>
                  <img src={imagenesObjetivo[imagenActual]} alt={`Imagen ${imagenActual + 1}`} className="imagen-objetivo-grande"style={{ marginLeft: '20px', marginTop:'70px' }}  />
                  <div>
                    ...
                    <p style={{ marginLeft: '10em', color: 'black', marginBottom: '50px' , textAlign:'justify', width:'500px'}}>Parece una utopía, pero en ominova siempre buscamos ser los mejores en servicio integral, y es eso lo que ofrecemos, un servicio de marketing digital integral de calidad pensando en todo momento cómo mejorar el retorno al cliente y en hacerlo fácil y bonito.</p>
                    <p style={{ marginLeft: '17em', fontWeight: 'bold', fontSize: '15px', color: 'black',margingTop: '70px' }}></p>
                    
                    <div style={{ display: 'flex', alignItems: 'center', gap: '20px',fontFamily: 'Arial' }}>   
                    <Link to="/contacto" style={{ marginLeft:'250px', width:'99px' ,marginRight:'10px', }} className="blue-box" >
                        Contáctanos
                      </Link>
                      <span style={{ color: 'black' }}></span>
                      <Link to="/agencia" style={{ textDecoration: 'none', color: 'DarkBlack' }} className="white-box" >
                          Sobre nosotros
                        </Link>
                        </div>   
