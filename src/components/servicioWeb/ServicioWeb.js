...
import Consultoria from '../consultoria/Consultoria'; // Importa el componente Consultoria
import './../../App.css';
...
function ServicioWeb() {
  ...
  return (
    <div>
      ...
      {showServicioWeb && <ServicioWeb />}
      {showConsultoria && <Consultoria />}
    </div>
  );
}
