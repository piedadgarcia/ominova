...
function CasosDeExito1Retos() {
 ...
 <p style={{ marginTop: '10px' }}>Al desarrollar una web clara, sencilla y fácil de usar por los usuarios en cualquier dispositivo, generamos que la web apareciera en primera página de búsquedas para diversas palabras clave de suministros técnicos industriales y climatización relacionadas con Guadalajara.</p>
        ...
        backgroundColor: 'hsl(211, 90%, 96%)', // Fondo azul clarito
         ...
         <p style={{ marginTop: '10px' }}>Creamos una experiencia cálida y cercana al navegar por las plataformas de CHAGAR que transmite la eficiencia y calidad de sus suministros industriales y de climatización. Lo conseguimos a través de un rebranding y su posterior aplicación a todos los soportes.</p>   
