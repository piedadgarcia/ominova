...
<p className="texto-centrado">
  ...
  <button className="boton-toggle" onClick={() => toggleTexto('mision')}>
    {textoVisible === 'mision' ? '˅' : '^'}
  </button>
</p>
{textoVisible === 'mision' && (
...
<p className="texto-centrado">
  ...
  <button className="boton-toggle" onClick={() => toggleTexto('vision')}>
    {textoVisible === 'vision' ? '˅' : '^'}
  </button>
</p>
{textoVisible === 'vision' && (
  <p className="texto-normal2">
    Revolucionar la industria del marketing y la tecnologia de máximo nivel, haciéndola accesible
    económicamaente, justa, transparente, industrializada, cercana y rentable.
    Convertirnos en la empresa de marketing más importante de España en 5 años.
  </p>
)}
...
<p className="texto-centrado valores">
  ...
  <button className="boton-toggle" onClick={() => toggleTexto('valores')}>
...
{textoVisible === 'valores' && (
  <>
    ...
    <p className="texto-normal3">
      En Ominova creemos en 4 pilares fundamentales que son la ayuda, la humildad, la mejora continua y la competitividad.
    </p>
  </>
)}
